...
from src.model.KNN.VirtualNN import UserVNN, ItemVNN
from src.tuning.run_parameter_search_VNN import run_parameter_search_VNN
...
def main():
    ...
    run_parameter_search_VNN(URM_train=URM_train,
