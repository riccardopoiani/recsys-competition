...
def _get_all_models(URM_train, ICM_all, UCM_all, ICM_numerical, ICM_categorical):
    all_models = {}
...
if __name__ == '__main__':
    ...
    all_models = _get_all_models(URM_train=URM_train, UCM_all=UCM_age_region,
