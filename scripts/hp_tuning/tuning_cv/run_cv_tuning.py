...
MIN_LOWER_THRESHOLD = 23  # Remove users below or equal this threshold (default value: -1)
MAX_UPPER_THRESHOLD = 2 ** 16 - 1  # Remove users above or equal this threshold (default value: 2**16-1)
