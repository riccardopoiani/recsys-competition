...
from src.data_management.data_reader import read_target_users, read_URM_cold_all, read_UCM_cold_all, get_ICM_all_new, \
    get_UCM_all_new, get_UCM_all, get_ICM_all, read_UCM_cold_all_with_user_act
from src.model import best_models, best_models_lower_threshold_23, best_models_upper_threshold_22, k_1_out_best_models, \
    new_best_models
...
if __name__ == '__main__':
    ...
    main_recommender = best_models_lower_threshold_23.WeightedAverageItemBasedWithRP3.get_model(URM_all, ICM_all)
