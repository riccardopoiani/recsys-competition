...
from src.data_management.data_reader import get_ICM_all_new, get_UCM_all_new, get_ICM_all, read_URM_cold_all, \
    read_UCM_cold_all, read_target_users
from src.model import best_models, best_models_lower_threshold_23, best_models_upper_threshold_22, new_best_models
...
if __name__ == '__main__':
    ...
    lt_23_recommender = new_best_models.WeightedAverageItemBased.get_model(URM_train=URM_all, ICM_all=ICM_all)
