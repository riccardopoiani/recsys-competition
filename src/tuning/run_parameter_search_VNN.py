...
def run_VKNNRecommender_on_similarity_type(similarity_type, parameterSearch,
    ...
    hyperparameters_range_dictionary["threshold_sim"] = Real(low=0.05, high=0.25, prior="uniform")
    hyperparameters_range_dictionary["threshold_count"] = Integer(2, 10)
