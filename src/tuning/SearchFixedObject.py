...
class SearchFixedObject(object):

    ALGORITHM_NAME = "SearchFixedObject"
    ...
    def __init__(self, recommender_class,
        ...
        super(SearchFixedObject, self).__init__()

        self.recommender_object = recommender_class
    ...
    def _init_metadata_dict(self, n_cases):
        ...
        self.metadata_dict = {"algorithm_name_search": self.ALGORITHM_NAME,
                              "algorithm_name_recommender": self.recommender_object.RECOMMENDER_NAME,
    ...
    def _fit_model(self, current_fit_parameters):
        ...
        recommender_instance = self.recommender_object.copy()
