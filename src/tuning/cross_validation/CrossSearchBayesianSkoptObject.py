...
from src.tuning.cross_validation.CrossSearchFixedObject import CrossSearchFixedObject


class CrossSearchBayesianSkoptObject(CrossSearchFixedObject):
    ALGORITHM_NAME = "CrossSearchBayesianSkoptObject"

    def __init__(self, recommender_object_list, evaluator_validation_list=None, verbose=True):

        assert evaluator_validation_list is not None, "{}: evaluator_validation must be provided".format(
            self.ALGORITHM_NAME)

        super(CrossSearchBayesianSkoptObject, self).__init__(recommender_object_list,
    ...
    def search(self, recommender_input_args_list,
        ...
        :param recommender_input_args_list:
        ...
        self._set_search_attributes(recommender_input_args_list,
                                    metric_to_optimize,
                                    output_folder_path,
