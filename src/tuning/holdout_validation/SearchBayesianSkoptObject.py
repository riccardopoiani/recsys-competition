...
from src.tuning.holdout_validation.SearchFixedObject import SearchFixedObject
import traceback


class SearchBayesianSkoptObject(SearchFixedObject):
    ...
    def __init__(self, recommender_class, evaluator_validation=None, evaluator_test=None, verbose=True):
        ...
        super(SearchBayesianSkoptObject, self).__init__(recommender_class,
