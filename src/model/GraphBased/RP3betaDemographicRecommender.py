...
class RP3betaDemographicRecommender(BaseItemSimilarityMatrixRecommender):
    """ RP3 beta DemographicRecommender """

    RECOMMENDER_NAME = "RP3betaDemographicRecommender"

    def __init__(self, URM_train, UCM_train, verbose=True):
        super(RP3betaDemographicRecommender, self).__init__(URM_train, verbose=verbose)
