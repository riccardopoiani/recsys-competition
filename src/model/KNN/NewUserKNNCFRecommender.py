...
class NewUserKNNCFRecommender(BaseUserSimilarityMatrixRecommender):
    """ New UserKNN recommender with feature weighting on items"""

    RECOMMENDER_NAME = "NewUserKNNCFRecommender"

    FEATURE_WEIGHTING_VALUES = ["BM25", "TF-IDF", "none"]

    def __init__(self, URM_train, verbose=True):
        super(NewUserKNNCFRecommender, self).__init__(URM_train, verbose=verbose)
