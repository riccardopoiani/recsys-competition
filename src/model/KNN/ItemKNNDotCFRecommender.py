...
class ItemKNNDotCFRecommender(BaseItemSimilarityMatrixRecommender):
    """ ItemKNNDotCFRecommender """

    RECOMMENDER_NAME = "ItemKNNDotCFRecommender"

    FEATURE_WEIGHTING_VALUES = ["BM25", "TF-IDF", "none"]

    def __init__(self, URM_train, verbose=True):
        super(ItemKNNDotCFRecommender, self).__init__(URM_train, verbose=verbose)
    ...
    def fit(self, topK=50, shrink=100, normalize=True, feature_weighting="none"):
        ...
        self.W_sparse = self.URM_train.T.dot(self.URM_train) * (1/denominator)
